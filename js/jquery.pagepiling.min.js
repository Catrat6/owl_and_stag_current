...
!function (e, n, t, o) {
    ...
    e.fn.pagepiling = function (i) {
      ...
      function c(n, t) {
        var o = {destination: n, animated: t, activeSection: e(".pp-section.active"), anchorLink: n.data("anchor"), sectionIndex: n.index(".pp-section"), toMove: n, yMovement: s(n), leavingSection: e(".pp-section.active").index(".pp-section") + 1};
        if (!o.activeSection.is(n)) {
          "undefined" == typeof o.animated && (o.animated = true), "undefined" != typeof o.anchorLink && v(o.anchorLink, o.sectionIndex), o.destination.addClass("active").siblings().removeClass("active"), o.sectionsToMove = p(o), "down" === o.yMovement ? (o.translate3d = U(), o.scrolling = "-100%", Z.css3 || o.sectionsToMove.each(function (n) {
      ...
      function b(n) {
        ...
        var r = o - _;
        if (_ = o, r > 200 && (G = []), !m()) {
          var l = e(".pp-section.active"), p = l.filter(".pp-scrollable"), d = y(G, 10), u = y(G, 70), v = d >= u;
          return v && c && (a < 0 ? x("down", p) : a > 0 && x("up", p)), false;
        }
      }
      function y(e, n) {
      ...
      function C() {
        F.get(0).addEventListener ? (F.get(0).removeEventListener("mousewheel", b, false), F.get(0).removeEventListener("wheel", b, false)) : F.get(0).detachEvent("onmousewheel", b);
      }
      function k() {
        F.get(0).addEventListener ? (F.get(0).addEventListener("mousewheel", b, false), F.get(0).addEventListener("wheel", b, false)) : F.get(0).attachEvent("onmousewheel", b);
      }
      function E() {
        if (R) {
          var e = D();
      ...
      function P(e) {
        ...
        if ("undefined" == typeof n.pointerType || "mouse" != n.pointerType) {
          var t = I(n);
          j = t.y, H = t.x;
        }
      }
      function Y(n) {
        ...
        if (!N(n.target) && ("undefined" == typeof t.pointerType || "mouse" != t.pointerType)) {
          var o = e(".pp-section.active"), i = o.filter(".pp-scrollable");
      ...
      function O() {
        var e, i = n.createElement("p"), a = {webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform"};
      ...
      e.extend(e.easing, {easeInQuart: function (e, n, t, o, i) {
        ...
        e ? (B.setMouseWheelScrolling(true), E()) : (B.setMouseWheelScrolling(false), L());
      ...
      }), Z.css3 && (Z.css3 = O()), e(F).css({overflow: "hidden", "-ms-touch-action": "none", "touch-action": "none"}), B.setAllowScrolling(true), e.isEmptyObject(Z.navigation) || q();
      ...
      e(".pp-section").each(function (n) {
        ...
        B.setMouseWheelScrolling(false);
      }), e(n).on("mouseleave", Z.normalScrollElements, function () {
        B.setMouseWheelScrolling(true);
      }));
